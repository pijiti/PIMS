class PharmItemsController < ApplicationController
  ...
  private
    ...
    def pharm_item_params
      ...
      brands_attributes: [:id, :name,:pack_bundle, :main_restock_level , :dispensary_restock_level, :marketer_id, :unit_dose_id, :concentration, :item_concentration_unit_id, :pack_size,:pharm_item_id,:min_dispensable ,  :_destroy])
    end
end
