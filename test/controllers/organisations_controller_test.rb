...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { address: @organisation.address, contact_person: @organisation.contact_person, logo: @organisation.logo, organisation_name: @organisation.organisation_name }
    end
  ...
  test "should update organisation" do
    patch :update, id: @organisation, organisation: { address: @organisation.address, contact_person: @organisation.contact_person, logo: @organisation.logo, organisation_name: @organisation.organisation_name }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
